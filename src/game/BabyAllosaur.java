...
/**
 * Class for babyAllosaur
 * @see Dinosaur
 */
public class BabyAllosaur extends Dinosaur {
    /**
     * Behaviour of BabyAllosaur
     */
    private Behaviour behaviour;
    /**
     * number of turns experienced by a dinosaur
     */
    private int turn;
     ...
     * is to let the actor could experience the time and action would be returned according to the BabyAllosaur condition.
    ...
    public Action playTurn(Actions actions, Action lastAction, GameMap map, Display display) {
       ...
       hurt(1);
       reduceWaterPts(1);
        if (this.isConsciousThirsty()){ //check the BabyAllosaur is conscious or unconscious due to water points is 0
            turn++;
            if (turn==15){
